 ...
 */
public class BlockMetalBrushedSteelDark extends Block {
    public BlockMetalBrushedSteelDark() {
        super(Material.ROCK);
        setUnlocalizedName(Reference.ModBlocks.METAL_BRUSHED_STEEL_DARK.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.METAL_BRUSHED_STEEL_DARK.getRegistryName());
