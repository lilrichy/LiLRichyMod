 ...
 */
public class BlockConcreteSmallTexturedSquares extends Block {
    public BlockConcreteSmallTexturedSquares() {
        super(Material.ROCK);
        setUnlocalizedName(Reference.ModBlocks.CONCRETE_SMALL_TEXTURED_SQUARES.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CONCRETE_SMALL_TEXTURED_SQUARES.getRegistryName());
