 ...
 */
public class BlockConcreteSmallBricks extends Block {
    public BlockConcreteSmallBricks() {
        super(Material.ROCK);
        setUnlocalizedName(Reference.ModBlocks.CONCRETE_SMALL_BRICKS.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CONCRETE_SMALL_BRICKS.getRegistryName());
