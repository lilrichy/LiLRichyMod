 ...
 */
public class BlockCottageWallDark extends Block {
    public BlockCottageWallDark() {
        super(Material.WOOD);
        setUnlocalizedName(Reference.ModBlocks.COTTAGE_WALL_DARK.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.COTTAGE_WALL_DARK.getRegistryName());
