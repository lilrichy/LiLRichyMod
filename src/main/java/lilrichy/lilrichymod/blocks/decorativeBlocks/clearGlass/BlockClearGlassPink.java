 ...
 */
public class BlockClearGlassPink extends Block {
    public BlockClearGlassPink() {
        super(Material.GLASS);
        setUnlocalizedName(Reference.ModBlocks.CLEAR_GLASS_PINK.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CLEAR_GLASS_PINK.getRegistryName());
