 ...
 */
public class BlockClearGlassYellow extends Block {
    public BlockClearGlassYellow() {
        super(Material.GLASS);
        setUnlocalizedName(Reference.ModBlocks.CLEAR_GLASS_Yellow.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CLEAR_GLASS_Yellow.getRegistryName());
