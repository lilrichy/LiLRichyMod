 ...
 */
public class BlockClearGlassBlue extends Block {
    public BlockClearGlassBlue() {
        super(Material.GLASS);
        setUnlocalizedName(Reference.ModBlocks.CLEAR_GLASS_BLUE.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CLEAR_GLASS_BLUE.getRegistryName());
