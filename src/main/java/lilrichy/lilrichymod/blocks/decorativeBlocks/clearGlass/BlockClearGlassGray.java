 ...
 */
public class BlockClearGlassGray extends Block {
    public BlockClearGlassGray() {
        super(Material.GLASS);
        setUnlocalizedName(Reference.ModBlocks.CLEAR_GLASS_GRAY.getUnlocalizedName());
        setRegistryName(Reference.ModBlocks.CLEAR_GLASS_GRAY.getRegistryName());
